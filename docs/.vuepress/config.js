...
module.exports = {
  ...
  themeConfig: { // 主题配置
    ...
    repo: 'dakang824', // 导航栏右侧生成Github链接
    ...
    blogger: { // 博主信息，显示在首页侧边栏
      avatar: 'https://thirdwx.qlogo.cn/mmopen/vi_32/5HjjnLYsOvWaQiajNs4Fia4KUE1MF2jmux2U6oDwJicU6TwfTLOqBeUmFmzu8aRfAR8j8y146OvdgGKSnwPodlsxQ/132',
      name: 'YU Kang',
      slogan: '前端界的小学生'
    },
  ...
  plugins: [ // 插件
    ...
    [
      ...
      // },
      {
        choosen: 'gitalk',
        options: {
          clientID: 'e65010a19c0c39a5e0e2',
          clientSecret: '2af55368820518df7018d28dded1bf4e6f73b0c9',
          repo: 'blog-gitalk-comment', // GitHub 仓库
          owner: 'dakang824', // GitHub仓库所有者
          admin: ['dakang824'], // 对仓库有写权限的人
